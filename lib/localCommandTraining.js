...
const ALLOWED_ACTIONS = new Set(['list', 'search', 'prepare-draft', 'publish-draft']);
...
const BUILT_IN_COMMAND_PACK = [
  ...
  { id: 'builtin-publish-now', phrase: 'انشر {title}', action: 'publish-draft' },
  { id: 'builtin-publish-now-post', phrase: 'انشر منشور {title}', action: 'publish-draft' },
  { id: 'builtin-publish-now-site', phrase: 'انشر {title} على الموقع', action: 'publish-draft' },
];
