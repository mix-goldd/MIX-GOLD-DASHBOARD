...
const HELP_TEXT = {
  categories: 'تصنيفات الأنمي: أضف أو احذف تصنيفات الأنمي (شونين، سينين، شوجو، إيسيكاي، ميكا، إلخ). اسحب المقبض لإعادة الترتيب، اضغط القلم لإعادة التسمية، واستخدم المفتاح لتفعيل التصنيف أو تعطيله دون حذفه. تظهر هذه عند إضافة محتوى جديد.',
  sidebar: 'عناصر القائمة الجانبية: إدارة روابط تنقل مخصصة لموقع الأنمي. استخدم الأسهم لإعادة الترتيب، والقلم للتعديل، وسلة المهملات للحذف.',
  homepage: "أقسام الصفحة الرئيسية: أضف أقسامًا مخصصة (مثال: 'الأنمي الرائج'، 'حلقات جديدة'، 'مانجا مشهورة') لصفحة الأنمي الرئيسية.",
    ...
    <Layout title="مدير المحتوى" session={session}>
      <div dir="rtl" className="am-panel">
        <p className="helper-text" style={{ marginBottom: 16 }}>
          تخصيص القائمة الجانبية، أقسام الصفحة الرئيسية، وتصنيفات الأنمي. أي تغيير هنا ينشر مباشرة على موقع S-E.
        </p>
        ...
        <div className="card am-settings-section">
          <div className="am-settings-title">
            <i className="fas fa-tags" /> تصنيفات الأنمي
